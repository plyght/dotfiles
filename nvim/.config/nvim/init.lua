...
require('lazy').setup({
  ...
  
  {
    ...
    config = function()
      ...
      local greeting = 'good night, nicholas'
      if hour >= 5 and hour < 12 then
        greeting = 'good morning, nicholas'
      elseif hour >= 12 and hour < 17 then
        greeting = 'good afternoon, nicholas'
      elseif hour >= 17 and hour < 22 then
        greeting = 'good evening, nicholas'
      elseif hour >= 0 and hour < 5 then
        greeting = 'still awake, nicholas'
      end
      starter.setup({
        ...
        items = {
          ...
          { action = function() require('fff').find_files() end, name = 'find file', section = '' },
          {
            action = function()
  ...
  
  {
    ...
    config = function()
      ...
      local ensure_installed = { 'bash', 'c', 'lua', 'markdown', 'markdown_inline', 'vim', 'vimdoc' }
